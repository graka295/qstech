                        ...
                        <div class="card">
                            ...
                            <div class="card-body order-datatable">
                                <div class="container emp-profile">
                                    <form class="form-horizontal" method="POST" id="form-update" action="<?= site_url("admin/list-admin/doUpdate") ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6">
                                                <div class="profile-head">
                                                    ...
                                                    <div class="row mb-1">
                                                        ...
                                                        <div class="col-6">
                                                            <input maxlength="30" type="text" name="first_name" id="first_name" class="form-control frm uppercase" value="<?= $users->first_name ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
                                                        <div class="col-3">
                                                        ...
                                                        <div class="col-6">
                                                            <input maxlength="30" type="text" name="last_name" id="last_name" class="form-control frm uppercase" value="<?= $users->last_name ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
                                                        <div class="col-3">
                                                        ...
                                                        <div class="col-6">
                                                            <input maxlength="30" type="text" name="email" id="email" class="form-control frm" value="<?= $users->email ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
                                                        <div class="col-3">
                                                        ...
                                                        <div class="col-6">
                                                            <input maxlength="30" type="text" name="no_hp" id="no_hp" class="form-control frm uppercase" value="<?= $users->handphone ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
                                                        <div class="mt-4">
        ...
        $("#form-update").validate({
            ...
            submitHandler: function(form) {
                if ($("#form-update").hasClass("success")) {
                    ...
                    validate(data, '<?= site_url("admin/list-admin/validateUpdate") ?>', "#form-update")
                }
            },
        });
    })
