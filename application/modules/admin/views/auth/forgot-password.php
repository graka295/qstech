        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form class="form-horizontal m-t-20" id="forgot-password-form" method="POST" action="">
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input name="email_forgot_password" id="email_forgot_password" type="email" maxlength="40" class="form-control form-control-xl" placeholder="<?= $this->lang->line('form_email_address') ?>" aria-label="Username" aria-describedby="basic-addon1" required="">
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p><a class="font-bold" href="<?= site_url("/admin")?>">login</a>.</p>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            $("#forgot-password-form").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        data: data,
                        url: '<?= site_url("admin/auth/forgotPassword") ?>',
                        type: "POST",
                        dataType: 'json',
                        success: function(e) {
                            if (!e.success) {
