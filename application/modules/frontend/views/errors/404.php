...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url()?>/assets/admin/assets/css/pages/error.css">
</head>
    ...
    <div id="error">
        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <img class="img-error" src="<?= base_url()?>/assets/admin/assets/images/samples/error-404.png" alt="Not Found">
